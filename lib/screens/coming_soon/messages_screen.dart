...
/// Coming Soon placeholder screen for the Messages feature.
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'We\'re building a messaging feature that will let you have '
                  'private conversations with other Boldask members.',
              ...
              Wrap(
                ...
                children: [
                  SecondaryButton(
                    ...
                    onPressed: () => context.push(Routes.follow),
                  ),
                  SecondaryButton(
                    text: 'Join Circles',
                    isExpanded: false,
              ...
              // Meanwhile suggestion
              Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
                  color: BoldaskColors.success.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: BoldaskColors.success.withOpacity(0.3),
                  ),
                ),
                child: Column(
                  children: [
                    ...
                    Text(
                      'Connect with others through Circles! Join topic-based groups '
                      'to engage in discussions with like-minded members.',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        'We\'ll notify you when Messages launches!',
  ...
  Widget _buildFeaturePreview(BuildContext context) {
    ...
    final features = [
      _FeatureItem(
        ...
        description: 'Direct messaging with other members',
      ),
      _FeatureItem(
        icon: Icons.group_outlined,
        title: 'Group Chats',
        description: 'Create conversations with multiple people',
      ),
      _FeatureItem(
